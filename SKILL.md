...
Dashboard 所需的 Root facts 与 visualization snapshot 走单入口 deterministic bootstrap；controller 不再手工串联 start-run / intake / init / dashboard。visualization control 的研究含义和候选使用仍由 `references/runtime/alpha-intake.md` 决定。
